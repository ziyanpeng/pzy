...
class SwinTransformerEncoder(SwinTransformer, EncoderMixin):
    ...
    def feature_forward(self, x):
        x = self.patch_embed(x)               #[4, 128, 64, 64]
        ...
        if self.ape:
            ...
            x = x.flatten(2).transpose(1, 2)       #[4, 4096, 128]
        x = self.pos_drop(x)                       #[4, 4096, 128]
    ...
    def forward(self, x):
        ...
        add_feature = F.interpolate(outs[0], scale_factor=2)  #torch.Size([4, 128, 128, 128])
